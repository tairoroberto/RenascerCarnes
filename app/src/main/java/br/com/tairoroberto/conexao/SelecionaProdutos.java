...
/***************************************************************************/ 
public class SelecionaProdutos extends AsyncTask<String, Void, String> {

	private final int TIMEOUT_MILLISEC = 10000;
	Context contexto;
	
	public SelecionaProdutos(Context c){
		this.contexto = c;
	}
	...
	protected String doInBackground(String... parametros) {
		try {
			...
			json.put("dataPedido", parametros[1]);
			...
			/***************************************************************************/
			String url = "http://www.tairoroberto.kinghost.net/selecionaProdutoSexta";
