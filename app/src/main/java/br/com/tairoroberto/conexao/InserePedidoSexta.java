...
/***************************************************************************/ 
public class InserePedidoSexta extends AsyncTask<String, Void, String> {

	private final int TIMEOUT_MILLISEC = 10000;
     Context contexto;

     public InserePedidoSexta(Context c){
 		this.contexto = c;
 	}
	...
	protected String doInBackground(String... parametros) {
        ...
        HttpPost post = new HttpPost("http://www.tairoroberto.kinghost.net/inserirProdutoSexta");
        try {
            ...
            valores.add(new BasicNameValuePair("quantidadeSexta", parametros[3]));
            valores.add(new BasicNameValuePair("tipoSexta", parametros[4]));
