...
import android.widget.Toast;
	...
	/***************************************************************************/ 
	public class DeletaPedidoSexta extends AsyncTask<String, Void, String> {

		private final int TIMEOUT_MILLISEC = 10000;
	     Context contexto;

	     public DeletaPedidoSexta(Context c){
	 		this.contexto = c;
	 	}
		...
		protected String doInBackground(String... parametros) {
            ...
            HttpPost post = new HttpPost("http://www.tairoroberto.kinghost.net/deletaPedidoSexta");
            try {
