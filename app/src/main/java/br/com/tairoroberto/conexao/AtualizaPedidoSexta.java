...
public class AtualizaPedidoSexta  extends AsyncTask<String, Void, String> {

	private final int TIMEOUT_MILLISEC = 10000;
	Context contexto;

	public AtualizaPedidoSexta(Context c){
		this.contexto = c;
	}
	protected String doInBackground(String... parametros) {
		try {
			...
			/***************************************************************************/
			String url = "http://www.tairoroberto.kinghost.net/atualizaProdutoSexta";
